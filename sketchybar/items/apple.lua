...
local apple_logo = sbar.add("item", "logo", logo)

local logo_about = sbar.add("item", "logo_about", {
...
local logo_settings = sbar.add("item", "logo_settings", {
	position = "popup." .. apple_logo.name,
	icon = { string = "􀍟 " },
	label = { string = "系统设置" },
})
...
local logo_activity = sbar.add("item", "logo_activity", {
	position = "popup." .. apple_logo.name,
	icon = { string = "􀜚 " },
	label = { string = "活动监视器" },
})
...
local logo_lock = sbar.add("item", "logo_lock", {
	position = "popup." .. apple_logo.name,
	icon = { string = "􀼑 " },
	label = { string = "锁定屏幕" },
})
...
local logo_refresh = sbar.add("item", "logo_refresh", {
	position = "popup." .. apple_logo.name,
	icon = { string = "􀅈 " },
